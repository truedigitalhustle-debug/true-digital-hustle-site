...
export const TOOLS = {
    title: "My AI Creator Toolkit",
    items: [
      { name: "ChatGPT", what: "Brainstorms ideas, writes prompts, scripts, and marketing content.", why: "Great for planning and creative problem-solving.", best: "Creators, marketers, and entrepreneurs." },
      { name: "Claude", what: "Helps with coding, technical writing, and organizing complex projects.", why: "Excellent for structured thinking and technical workflows.", best: "Developers, business owners, and technical creators." },
      { name: "OpenArt", what: "Creates AI-generated images and videos from prompts.", why: "One of my favorite tools for producing cinematic visuals.", best: "AI artists, filmmakers, and content creators." },
      { name: "Magica", what: "Creates AI-powered videos and creative content.", why: "A powerful option for turning ideas into polished AI videos.", best: "Creators who want to produce engaging video content." },
      { name: "CapCut", what: "Edits videos for social media with captions, effects, and transitions.", why: "Fast, beginner-friendly, and packed with useful editing features.", best: "TikTok, Instagram Reels, and YouTube Shorts creators." },
      { name: "VS Code", what: "A professional code editor for building websites and applications.", why: "Flexible, fast, and works with a huge ecosystem of extensions.", best: "Developers and creators building custom websites or apps." },
        ],
    proTip: "You don't need every AI tool. Start with a few that fit your workflow and master them before adding more.",
};
