const faqs = [
  {
        ...
        answer:
                "Yes. The AI Creator Starter Kit is completely free to download, no credit card, no email, and no signup required.",
  },
  {
  ...
  },
  {
        ...
        answer:
                "Yes. The Starter Kit is actively updated with new prompt categories and resources over time.",
  },
  ];
