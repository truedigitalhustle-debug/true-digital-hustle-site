...
export default function Hero() {
  return (
    ...
    Free Download &middot; No spam, ever
</span>

<h1 className="text-4xl font-semibold leading-[1.1] tracking-tight text-foreground sm:text-6xl">
Get 100+ AI Prompts That Help You{" "}
<span className="text-gradient">Create Better Content Faster</span>
    </h1>

    <p className="mt-6 max-w-2xl text-lg leading-relaxed text-muted sm:text-xl">
    Download the same style of prompts used to create cinematic AI
videos, viral social media content, realistic storytelling,
  marketing assets, and high-converting creative projects.
</p>
...
<div id="get-pack" className="mt-16 w-full max-w-md scroll-mt-24">
  <EmailForm />
  </div>
  </div>
  </section>
